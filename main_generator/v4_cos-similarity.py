...
with open("../result/second_mapping_v4_mapping.json", "w", encoding="utf-8") as writeJsonfile:
    json.dump(res, writeJsonfile, indent=4, default=str)

with open("../result/second_mapping_v4_random_sampling.json", "w", encoding="utf-8") as writeJsonfile2:
